...
[![Latest Version on NPM](https://img.shields.io/npm/v/uu-vue-draggable-resizable.svg?style=flat-square)](https://www.npmjs.com/package/uu-vue-draggable-resizable)
[![Software License](https://img.shields.io/badge/license-MIT-brightgreen.svg?style=flat-square)](LICENSE.md)
[![npm](https://img.shields.io/npm/dt/uu-vue-draggable-resizable.svg?style=flat-square)](https://www.npmjs.com/package/uu-vue-draggable-resizable)
...
```bash
$ npm install --save uu-vue-draggable-resizable
```
...
```js
import Vue from 'vue'
import VueDraggableResizable from 'uu-vue-draggable-resizable'
